package dev.cherrypizza.mcserver.bootstrap.utils.coroutine
 ...
 * Точка входа — [dev.cherrypizza.mcserver.bootstrap.MicronautServerPlugin.onDisable], которая оборачивает
